  ...
  return (
    <div className='mt-[30px] bg-[#f7f8f8] h-[180px]'>
        ...
        <div className='ml-[6%] social'>
          ...
          <div className='my-div h-[28px] flex w-[98px] gap-2 mt-[30px]'><img className='my-img  h-[100%]' src={iconapple} alt="" />
          <img className='my-img h-[100%]' src={icongoogle} alt="" />
          <img className='mt-img2 h-[100%]' src={icongarllery} alt="" /></div>
        </div>
        </div>
    </div>
  )
